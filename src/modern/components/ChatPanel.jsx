...
`;
  ...
  return (
    <div className={styles.shell} aria-label="Ask me anything">
      <div className={styles.frame}>
        ...
        <form className={styles.composer} onSubmit={handleSubmit}>
          ...
          <button
            ...
            aria-label="Send message to the site assistant"
          >
            <span>Send</span>
      ...
      {/* Sending a message to a third-party model provider is a disclosure
          that has to be visible before you type, not buried in the policy. */}
      <p className={styles.disclosure}>
        Answers are generated by a third-party language model and{" "}
        <strong>can be wrong</strong>. What you type is sent to that provider
        for processing — please don't enter anything confidential or personal.{" "}
        <Link to="/privacy" className={styles.disclosureLink}>
